    ...
    <nav className="relative px-8 pb-4 pt-6 sm:pt-8">
      <div className="flex flex-wrap items-center gap-x-5 gap-y-4 sm:flex-nowrap sm:gap-x-0">
        <button
          ...
          className="shrink-0 text-base font-normal leading-none text-foreground motion-reduce-safe-opacity transition-opacity hover:opacity-65 sm:text-lg md:text-xl"
        >
          I'm Josua
        </button>
        ...
        <div className="flex min-w-0 flex-wrap items-center gap-x-5 gap-y-3 sm:flex-nowrap sm:gap-x-7 md:gap-x-8">
          {navItems.map((item) => (
            <button
              ...
              className={`shrink-0 text-base font-normal leading-none text-foreground motion-reduce-safe-opacity transition-opacity hover:opacity-65 sm:text-lg md:text-xl ${activeSection === item.id ? "opacity-100" : "opacity-78"
                }`}
